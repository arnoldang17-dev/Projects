...
public class part2 {
    ...
    boolean setPiece(int letter, int number) {
    ...
    boolean checkCoordinates(int fNumber, int sNumber, int fLetter_num, int sLetter_num, int length, String piece) {
                                    // 9            8            2                 2
    ...
    boolean checkCoordinates(char letter, int number) {
    ...
    public static void main(String[] args) {
        ...
        while (allSetPieces) {
            ...
            if (!check) {
                ...
                allSetPieces = battleShip.setPiece(Letter_num, number);
